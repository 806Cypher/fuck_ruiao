...
def initFirst(userId):
    ...
    body = '''<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
              ...
              <a:Value i:type="b:string" xmlns:b="http://www.w3.org/2001/XMLSchema">{"ID":0,"LabID":364,"UserID":"''' + str(
...
def initSecond(userId):
    ...
    <a:Value i:type="b:string" xmlns:b="http://www.w3.org/2001/XMLSchema">{"ID":0,"USERID":"''' + str(
        userId) + '''","LABID":364,"STARTTIME":"\/Date(-62135596800000+0800)\/","ENDTIME":"\/Date(-62135596800000+0800)\/","Mark":"1","LabDateUrl":null,"Score":0}</a:Value></a:KeyValueOfstringanyType></Parameters></request></DoService></s:Body></s:Envelope>'''
