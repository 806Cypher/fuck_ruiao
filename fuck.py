...
def initFirst(userId):
    ...
    body = '''<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/">
              ...
              <a:Value i:type="b:string" xmlns:b="http://www.w3.org/2001/XMLSchema">{"ID":0,"LabID":393,"UserID":"''' + str(
...
def initSecond(userId):
    ...
    <a:Value i:type="b:string" xmlns:b="http://www.w3.org/2001/XMLSchema">{"ID":0,"USERID":"''' + str(
        userId) + '''","LABID":393,"STARTTIME":"\/Date(-62135596800000+0800)\/","ENDTIME":"\/Date(-62135596800000+0800)\/","Mark":"1","LabDateUrl":null,"Score":0}</a:Value></a:KeyValueOfstringanyType></Parameters></request></DoService></s:Body></s:Envelope>'''
...
def setScore(userId, id, score):
    ...
    body = '<s:Envelope xmlns:s="http://schemas.xmlsoap.org/soap/envelope/"><s:Body><DoService xmlns="http://www.ustcori.com/2009/10"><request xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><BizCode>UstcOri.BLL.BLLLabClent</BizCode><EnableCache>false</EnableCache><MethodName>SetLabTimeRecord</MethodName><Parameters xmlns:a="http://schemas.microsoft.com/2003/10/Serialization/Arrays"><a:KeyValueOfstringanyType><a:Key>labTime</a:Key><a:Value i:type="b:string" xmlns:b="http://www.w3.org/2001/XMLSchema">{"ID":' + str(
        id) + ',"USERID":"' + str(
        userId) + '","LABID":393,"STARTTIME":"\/Date(-62135596800000+0800)\/","ENDTIME":"\/Date(-62135596800000+0800)\/","Mark":"2","LabDateUrl":"Upload\\\\LabDate\\\\02-光栅单色仪实验\\\\' + str(
...
def main():
    ...
    serilizeStatus = sendFile(userId)
    setScoreStatus = setScore(userId, id2, 60)
